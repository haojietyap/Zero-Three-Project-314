...
-- Table structure for table `management_profiles`
...
-- Dumping data for table `management_profiles`


INSERT INTO `management_profiles` (`profile_id`, `user_id`, `phone`, `address`, `status`) VALUES
...
(3, 'Chloe Tan', 'chloetan@gmail.com', 'manager_pwd', 'management', 'active'),
(4, 'David Lim', 'davidlim@gmail.com', 'mgmt_pass', 'management', 'active'),
...
(20, 'Victor Wong', 'victorwong@gmail.com', 'PIN', 'PIN', 'active');
...
-- Indexes for table `management_profiles`
...
-- AUTO_INCREMENT for table `management_profiles`
ALTER TABLE `management_profiles`
...
-- Constraints for table `management_profiles`
ALTER TABLE `management_profiles`
  ADD CONSTRAINT `management_profiles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
